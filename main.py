...
#register A
    ...
    #total-----------------------------------
    self.totalWord = tk.Label(self, text="Total:", bg="teal").place(relx=0.07, rely=0.30)
...
#Register B
    ...
    #total-----------------------------------
    self.totalBWord = tk.Label(self, text="Total:", bg="teal").place(relx=0.41, rely=0.30)
...
#Register C
    ...
    #total-----------------------------------
    self.totalCWord = tk.Label(self, text="Total:", bg="teal").place(relx=0.74, rely=0.30)
    ...
    self.registerTotalLab.place(relx=0.14, rely=0.36)
    #float-------------------------------------
    self.floatAndNet = tk.DoubleVar()
    self.floatAndNet.trace_add("write", self.calculate)

    self.subtractFloat = tk.Label(self, text = "Total Profit:", bg="teal").place(relx=0, rely=0.40)
    self.inputFloat = tk.Entry(self, textvariable=self.floatAndNet, width="7", justify=tk.RIGHT, bg="teal").place(relx=0.085, rely=0.40)
    self.floatNumber = tk.Label(self, text = " - $489", bg="teal").place(relx=0.15, rely=0.40)

    self.NetProfitText = tk.Label(self, text = "Net Profit: ", bg="teal").place(relx=0, rely=0.47)

    self.NetProfitLab = tk.Label(self, text=self.floatAndNet.get())
    self.NetProfitLab.place(relx=0.075, rely=0.47)
...
#Register C
    ...
    #float
    try: netAmount = self.floatAndNet.get()
    except: netAmount = 0
    self.NetProfitLab['text'] = round((netAmount - 489), 2)
